...
The project is currently deployed on Render with PostgreSQL. The web service runs database migrations on startup and serves the Flask application with Gunicorn. T
